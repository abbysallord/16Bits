...
5. Configure Environment Variables:
   - `GROQ_API_KEY`, `AI_PROVIDER=groq`, `GROQ_MODEL=openai/gpt-oss-120b` (or `DEFAULT_MODEL=openai/gpt-oss-120b`)
...
- `POST /api/agents/webhook/alert` — Universal ingestion webhook (alias: `POST /api/webhooks/alerts`) for Datadog, PagerDuty, Grafana, or curl scripts.
